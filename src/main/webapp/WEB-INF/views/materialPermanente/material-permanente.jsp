		...
		<div class="row" style="margin-top:3%;">
			<form action="cadastrarMaterialPermanente?numeroProjeto=${projeto.numeroProjeto}" method="post">
				...
				<div class="col-md-10">
					...
					<select class="form-control" ng-model="item.materialPermanente" ng-options="materialPermanente.codigo +' - ' +materialPermanente.nome for materialPermanente in materiaisPermanente">
