				...
				<table class="table table-bordered">
	 				...
	 				<tbody>
	 					<c:forEach var="diaria" items="${diarias}">
	 						<tr>
	 							<th class="text-center" width="6%">${diaria.id}</th>
	 							<td>${diaria.descricao}</td>
	 							<td class="text-center text-muted" width="13%"><strong>R$</strong> ${diaria.valorUnitario}</td>
			                		...
			                		<div class="modal-content">
			                    		...
			                    		<div class="modal-body">
											...
											<div class="row" style="margin-top:3%">
												<div class="col-md-1"></div>
												<div class="col-md-4">
													<h4><strong><i class="fa fa-money" aria-hidden="true"></i> Valor da Diária R$</strong> ${d.valorUnitario}</h4>
												</div>
												<div class="col-md-3">
													<h4><strong><i class="fa fa-asterisk" aria-hidden="true"></i> Nº de Dias:</strong> ${d.quantidade}</h4>
												</div>
												<div class="col-md-4">
													<h4><strong><i class="fa fa-calculator" aria-hidden="true"></i> Valor Total R$</strong> ${d.valorTotal}</h4>
												</div>
											</div>
											<hr>
											<h4><strong><i class="fa fa-info-circle" aria-hidden="true"></i> Justificativa:</strong></h4> 
											<textarea class="form-control" rows="2" readonly>${d.justificativa}</textarea> 
			                    		</div>
