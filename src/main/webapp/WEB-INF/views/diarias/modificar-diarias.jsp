		...
		<div class="row" style="margin-top:2%;">
			...
			<div class="col-md-10">
	 				...
	 				<tbody>
	 					<c:forEach var="diaria" items="${diarias}">
	 						<tr>
	 							...
	 							<td class="text-center text-muted" width="10%"><strong>R$</strong> ${diaria.valorUnitario}</td>
	 							<td class="text-center text-muted" width="7%">${diaria.quantidade}</td>
	 							<td class="text-center text-muted" width="15%"><strong>R$</strong> ${diaria.quantidade * diaria.valorUnitario}</td>
	 							<td class="text-center" width="14%">
	 								...
	 								<a href="redirecionaAlterarDiarias?numeroProjeto=${projeto.numeroProjeto}&&valorTotal=${diaria.quantidade * diaria.valorUnitario}" class="btn btn-default btn-sm" title="Editar"><span class="glyphicon glyphicon-wrench text-success"></span></a>
	 								<a href="removerDiarias?numeroProjeto=${projeto.numeroProjeto}&&valorTotal=${diaria.quantidade * diaria.valorUnitario}" class="btn btn-default btn-sm" title="Remover" ><span class="glyphicon glyphicon-remove text-danger"></span></a>
	 							</td>
	 						</tr>
				...
				<c:if test="${empty diarias}">
					<h3 class="text-muted text-center">Não há Diárias cadastrados.</h3>
				</c:if>
			</div>
			<div class="col-md-1"></div>
		</div>
