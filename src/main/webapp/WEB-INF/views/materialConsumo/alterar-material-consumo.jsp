		...
		<div class="row" style="margin-top:3%;">
			...
			<form action="alterarMaterialConsumo?numeroProjeto=${projeto.numeroProjeto}&&id=${materialConsumo.id}" method="post">
				...
				<div class="col-md-10">
					<div class="row">
						<!-- DESCRIÇÃO -->
						<div class="col-md-8" ng-init="item.descricao='${materialConsumo.descricao}'">
							<jsp:include page="../formularios/descricao-trecho-destino.jsp"></jsp:include>
						</div>
						<!-- UNIDADE DE MEDIDA -->
						<div class="col-md-4" ng-init="unidadeMedida=unidadesMedida[procuraUnidade('${materialConsumo.unidadeMedida}')]">
					...
					<hr>	
					<div class="row">
						<div class="col-md-4" ng-init="item.valorUnit='${materialConsumo.valorUnitario}'">
							<jsp:include page="../formularios/valorUnitario.jsp"></jsp:include>
						</div>
						<div class="col-md-4" ng-init="item.quantidade='${materialConsumo.quantidade}'">
					...
					<!-- PERIODO -->
					<hr ng-init="user.meses=[${materialConsumo.periodo}]">
