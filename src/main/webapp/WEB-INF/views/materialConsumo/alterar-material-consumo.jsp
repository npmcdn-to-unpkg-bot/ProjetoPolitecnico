  ...
  <body ng-controller="formConsumoCtrl">
	...
	<div class="container" id="conteudo" style="margin-top: 1%;">
		...
		<div class="row" style="margin-top:3%;">
			...
			<form action="alterarMaterialConsumo?numeroProjeto=${projeto.numeroProjeto}&&id=${materialConsumo.id}" method="post">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="valorUnit" ng-model="item.valorUnit" ng-currency placeholder="<fmt:formatNumber value="${materialConsumo.valorUnitario}" type="currency"/>"/>
