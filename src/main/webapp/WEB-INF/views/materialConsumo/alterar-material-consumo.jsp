  ...
  <body ng-controller="formConsumoCtrl">
	...
	<div class="container" id="conteudo" style="margin-top: 1%;">
		...
		<ul class="nav nav-tabs" style="margin-top: 3%;" id="menu">
			...
			<li role="presentation" class="active"><a href="#">Alterar Material de Consumo</a></li>			
		</ul>
		...
		<ol class="breadcrumb" style="margin-top: 2%;">
			<li><a href="redirecionaInicio">Pagina Inicial</a></li>
	  		...
	  		<li class="active">Alterar Material de Consumo</li>
		</ol>

		<div class="row" style="margin-top:2%;">
			<c:forEach var="materialConsumo" items="${materialConsumo}">
			<form action="alterarMaterialConsumo?numeroProjeto=${projeto.numeroProjeto}&&codigoMaterial=${materialConsumo.codigoDemanda}&&valorTotal=${materialConsumo.valorTotal}" method="post">
				...
				<div class="col-md-10">
					<div class="row">
						<div class="col-md-8">
							<div class="form-group">
								...
								<textarea class="form-control" rows="2" name="descricao" placeholder="${materialConsumo.descricao}" ng-model="item.descricao"></textarea required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="form-control" ng-model="unidadeMedida" ng-options="unidadeMedida.nome group by unidadeMedida.categoria for unidadeMedida in unidadesMedida">
									<option value=""> ${materialConsumo.unidadeMedida} </option>
								</select>
					...
					<input type="text" class="form-control" name="subitem" value="${materialConsumo.codigoDemanda} - ${materialConsumo.subItem}" disabled/>
					<input type="hidden" name="subitem" value="${materialConsumo.codigoDemanda} - ${materialConsumo.subItem}"/>					
					<hr>	
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="valorUnitario" placeholder="${materialConsumo.valorUnitario}" ng-model="item.valorUnit" ui-number>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								<label for="quantidade">Quantidade</label>
								<input type="text" class="form-control" maxlength="10" name="quantidade" placeholder="${materialConsumo.quantidade}" ng-model="item.quantidade" ui-number>
							</div>
						</div>
						<div class="col-md-4">
