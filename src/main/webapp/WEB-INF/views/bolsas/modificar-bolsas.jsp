		...
		<div class="row" style="margin-top:3%;">
			...
			<div class="col-md-10">
				...
				<table class="table table-bordered">
	 				...
	 				<tbody>
	 					<c:forEach var="bolsa" items="${bolsas}">
	 						<tr>
	 							<td class="text-center text-info" width="5%">${bolsa.id}</td>
	 							<td>${bolsa.periodo}</td>
			                		...
			                		<div class="modal-content">
			                    		...
			                    		<div class="modal-body">
											...
											<div class="row" style="margin-top:3%">
												<div class="col-md-1"></div>
												<div class="col-md-4">
													<h4><strong><i class="fa fa-money" aria-hidden="true"></i> Valor Unitário <fmt:formatNumber value="${b.valorUnitario}" type="currency"/></h4>
												</div>
												<div class="col-md-3">
				...
				<c:if test="${empty bolsas}">
					<h3 class="text-muted text-center">Não há Bolsas cadastradas.</h3>
				</c:if>
			</div>
			<div class="col-md-1"></div>
		</div>
