			...
			<form action="alterarServicoTerceiros?numeroProjeto=${projeto.numeroProjeto}&&id=${servico.id}" method="post">
				...
				<div class="col-md-10">
					<div class="row">
						<div class="col-md-8">
							<div class="form-group">
								...
								<textarea class="form-control" rows="2" name="descricao" placeholder="${servico.descricao}" ng-model="item.descricao"></textarea required>
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
								...
								<select class="form-control" ng-model="unidadeMedida" ng-options="unidadeMedida.nome group by unidadeMedida.categoria for unidadeMedida in unidadesMedida">
									<option value=""> ${servico.unidadeMedida} </option>
								</select>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="valorUnit" ng-model="item.valorUnit" ng-currency placeholder="<fmt:formatNumber value="${servico.valorUnitario}" type="currency"/>"/>
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input type="text" class="form-control" maxlength="10" name="quantidade" placeholder="${servico.quantidade}" ng-model="item.quantidade" ui-number>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="justificativa" placeholder="${servico.justificativa}" rows="3" ng-model="item.justificativa"></textarea>
					</div>
